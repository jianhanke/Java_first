...
public class VisitInofrmation {
	...
	public static void show(String id){
		  ...
		  System.out.println("你选定第一门课课:"+  Course.getinstance().getAllcourse().get(course[0]) );
		  System.out.println("你选定第二门课课:"+  Course.getinstance().getAllcourse().get(course[1]) );
		  System.out.println("你选定第三门课课:"+  Course.getinstance().getAllcourse().get(course[2]) );
